...
if rad=='Homepage':
  ...
  strdate = datetime.combine(strdate, datetime.min.time())
  ...
  for i in forecast.index:
      if(strdate == forecast['ds'][i]):
        ...
        j=0
        if st.checkbox("Show Center Information data", key = j):
            for i in forecast.index:
  ...
  st.write("### I am a Computer Science Graduate from Vellore Institute of Technology")
footer="""<style>
a:link , a:visited{
color: blue;
...
<div class="footer">
<p>Developed with Streamlit by <br>Yaswanth</p>
</div>
"""
